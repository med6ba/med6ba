...
echo "<form method=POST action='employe-update.php' enctype='multipart/form-data'>";
echo "
<fieldset>
...
echo "<input type='file' name='photo' id='file' accept='image/*'' class='form-control'><div class='img-area' data-img=''><img src='images/".$data['photo']."'></div><button class='select-image btn btn-success' hidden>Select Image</button>";
...
echo "<input type='password' name='motdepasse' class='form-control' value='".$data['motdepasse']."'>";
echo "</div>";
echo "</div>";
echo "</fieldset>";
